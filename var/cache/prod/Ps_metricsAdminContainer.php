...
class Ps_metricsAdminContainer extends Container
{
    ...
    {
        return $this->services['ps_metrics.api.http'] = new \PrestaShop\Module\Ps_metrics\Api\HttpApi(($this->services['ps_metrics.api.client.http'] ?? $this->getPsMetrics_Api_Client_HttpService()), ($this->services['ps_metrics.helper.config'] ?? $this->getPsMetrics_Helper_ConfigService()));
    }
